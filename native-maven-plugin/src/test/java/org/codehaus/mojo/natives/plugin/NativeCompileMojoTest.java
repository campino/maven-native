    ...
    extends AbstractMojoTestCase
{
        ...
        throws Exception
    {
        ...
        // order of the list is not known
        assertTrue( objectFileList.contains( new File( "target/file11.o" ) ) );
        assertTrue( objectFileList.contains( new File( "target/file12.o" ) ) );
        assertTrue( objectFileList.contains( new File( "target/file21.o" ) ) );
        assertTrue( objectFileList.contains( new File( "target/file22.o" ) ) );
